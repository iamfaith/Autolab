...
module ApplicationHelper
  ...
  def external_stylesheet_link_tag(library)
    ...
    when "jquery-ui"
      ...
      stylesheet_link_tag "//127.0.0.1/local/jquery-ui.min.css"
    when "flatpickr"
      version = "4.6.13"
      # stylesheet_link_tag "#{cloudflare}/flatpickr/#{version}/flatpickr.min.css"
      stylesheet_link_tag "//127.0.0.1/local/flatpickr.min.css"
  ...
  def external_javascript_include_tag(library)
    ...
    when "jquery"
      ...
      javascript_include_tag "//127.0.0.1/local/jquery.min.js"
    when "jquery-migrate"
