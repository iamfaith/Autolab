...
module ApplicationHelper
  ...
  def external_stylesheet_link_tag(library)
    ...
    when "jquery-ui"
      ...
      stylesheet_link_tag "/local/jquery-ui.min.css"
    when "flatpickr"
      version = "4.6.13"
      # stylesheet_link_tag "#{cloudflare}/flatpickr/#{version}/flatpickr.min.css"
      stylesheet_link_tag "/local/flatpickr.min.css"
  ...
  def external_javascript_include_tag(library)
    ...
    when "jquery"
      ...
      javascript_include_tag "/local/jquery.min.js"
    when "jquery-migrate"
